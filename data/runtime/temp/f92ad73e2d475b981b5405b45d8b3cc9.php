<?php /*a:2:{s:77:"/www/wwwroot/eliveadmin/themes/admin_simpleboot3/admin/liveing/teidanmgt.html";i:1655428166;s:67:"/www/wwwroot/eliveadmin/themes/admin_simpleboot3/public/header.html";i:1654305693;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<body>
	<div class="wrap">
		<ul class="nav nav-tabs">
			<li class="active"><a >推单管理</a></li>
			<li><a href="<?php echo url('Liveing/teidanadd'); ?>"><?php echo lang('ADD'); ?></a></li>
		</ul>
		
		<form class="well form-inline margin-top-20" method="post" action="<?php echo url('Liveing/teidanmgt'); ?>">
			分类：
            <select class="form-control" name="type">
                ...
                <?php if(is_array($type) || $type instanceof \think\Collection || $type instanceof \think\Paginator): $i = 0; $__LIST__ = $type;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                    <option value="<?php echo $key; ?>" <?php if(input('request.type') == $key): ?>selected<?php endif; ?>><?php echo $v; ?></option>
			...
			<table class="table table-hover table-bordered">
				...
				<tbody>
					...
					<tr>
						...
						<td><?php echo $vo['liveinfo']; ?></td>						
						<td><?php echo $vo['type']; ?> </td>
						<td><?php echo $vo['title']; ?></td>
						<td><?php echo $vo['buy']; ?></td>
						<td><?php echo $vo['oppositebuy']; ?></td>
						<td><?php echo $vo['status']; ?></td>
						<th><?php echo $vo['addtime']; ?></th>
						<td>
                            <a class="btn btn-xs btn-primary" href='<?php echo url("Liveing/teidanedit",array("id"=>$vo["id"])); ?>'><?php echo lang('EDIT'); ?></a>
							<a class="btn btn-xs btn-danger js-ajax-delete" href="<?php echo url('Liveing/teidandel',array('id'=>$vo['id'])); ?>"><?php echo lang('DELETE'); ?></a>
						</td>
					</tr>
					<?php endforeach; endif; else: echo "" ;endif; ?>
				</tbody>
