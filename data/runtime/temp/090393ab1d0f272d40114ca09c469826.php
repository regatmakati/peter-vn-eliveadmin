<?php /*a:2:{s:68:"/www/wwwroot/eliveadmin/themes/admin_simpleboot3/admin/push/add.html";i:1768747103;s:67:"/www/wwwroot/eliveadmin/themes/admin_simpleboot3/public/header.html";i:1768747123;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<body>
	<div class="wrap">
		<ul class="nav nav-tabs">
			<li ><a href="<?php echo url('Push/index'); ?>">推送记录</a></li>
		...
		<form method="post" class="form-horizontal js-ajax-form margin-top-20" action="<?php echo url('Push/addPost'); ?>">
            ...
            <div class="form-group">
				...
				<div class="col-md-6 col-sm-10">
					<textarea class="form-control" id="input-content" name="content" ></textarea>推送的消息仅支持文字，不支持图片及视频文件
				</div>
			</div>
