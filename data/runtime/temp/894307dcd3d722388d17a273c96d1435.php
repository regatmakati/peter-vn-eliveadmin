<?php /*a:2:{s:70:"/www/wwwroot/eliveadmin/themes/admin_simpleboot3/admin/push/index.html";i:1768747103;s:67:"/www/wwwroot/eliveadmin/themes/admin_simpleboot3/public/header.html";i:1768747123;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<body>
	<div class="wrap">
		<ul class="nav nav-tabs">
			...
			<li ><a href="<?php echo url('Push/add'); ?>">发送</a></li>
		...
		<form class="well form-inline margin-top-20" name="form1" method="post" action="">
			...
			<input type="button" class="btn btn-success" value="导出" onclick="form1.action='<?php echo url('Push/export'); ?>';form1.submit();"/>
