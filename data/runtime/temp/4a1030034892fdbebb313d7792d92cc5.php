<?php /*a:2:{s:73:"/www/wwwroot/eliveadmin/themes/admin_simpleboot3/admin/watermark/add.html";i:1654305691;s:67:"/www/wwwroot/eliveadmin/themes/admin_simpleboot3/public/header.html";i:1654305693;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<body>
	<div class="wrap">
		<ul class="nav nav-tabs">
			...
			<li class="active"><a href="<?php echo url('watermark/add'); ?>"><?php echo lang('ADMIN_WATERMARK_ADD'); ?></a></li>
		</ul>
		<?php $position=array("1"=>"上左遮罩","2"=>"上右遮罩","3"=>"下左遮罩","4"=>"下右遮罩"); $device=array("1"=>"PC","2"=>"APP/H5"); ?>
		<form method="post" class="form-horizontal js-ajax-form margin-top-20" action="<?php echo url('watermark/addPost'); ?>">
