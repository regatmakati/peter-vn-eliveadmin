<?php /*a:1:{s:65:"/www/wwwroot/eliveadmin/themes/admin_simpleboot3/admin/login.html";i:1768747093;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8"/>
...
<div class="wrap">
    <div class="container">
        <div class="row">
            <div class="col-md-4 col-md-offset-2 wraps-1">
                <div class="wraps-1-1"><img src="/themes/admin_simpleboot3/public/assets/themes/<?php echo cmf_get_admin_style(); ?>/wel.png"></div>
                <div class="wraps-1-2"><img src="/themes/admin_simpleboot3/public/assets/themes/<?php echo cmf_get_admin_style(); ?>/log.png"></div>
                <div class="wraps-1-3">
                    <div class="wraps-1-4"></div>
                    <div class="wraps-1-4"></div>
                    <div class="wraps-1-4"></div>
                </div>
            </div>
            <div class="col-md-4 wraps-2">
                <div class="wraps-2-1">
                    <form class="js-ajax-form" action="<?php echo url('public/doLogin'); ?>" method="post">
                        ...
                        <div class="form-group code">
                            <div style="position: relative;">
                                <input type="text" name="captcha" id="input_captcha" placeholder="验证码" class="form-control captcha">
