<?php /*a:2:{s:76:"/www/wwwroot/eliveadmin/themes/admin_simpleboot3/admin/statistics/index.html";i:1768747113;s:67:"/www/wwwroot/eliveadmin/themes/admin_simpleboot3/public/header.html";i:1768747123;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<body>
	<div class="wrap">
		...
		<form class="well form-inline margin-top-20" name="form1" method="post" action="">
            ...
            <input type="button" class="btn btn-primary" value="查询" onclick="form1.action='<?php echo url('Statistics/index'); ?>';form1.submit();"/>
		</form>	
