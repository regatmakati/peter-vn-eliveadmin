<?php /*a:2:{s:71:"/www/wwwroot/eliveadmin/themes/admin_simpleboot3/admin/liveing/add.html";i:1655428165;s:67:"/www/wwwroot/eliveadmin/themes/admin_simpleboot3/public/header.html";i:1654305693;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<body>
	<div class="wrap">
		...
		<form method="post" class="form-horizontal js-ajax-form margin-top-20" action="<?php echo url('Liveing/addPost'); ?>">
			...
			<div class="form-group">
				<label for="input-words" class="col-sm-2 control-label"><span class="form-required">*</span>未推流是否手动关闭直播间<br/></label>
				<div class="col-md-6 col-sm-10">
					<select class="form-control" name="is_manual_close">
