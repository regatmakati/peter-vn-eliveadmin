<?php /*a:2:{s:76:"/www/wwwroot/eliveadmin/themes/admin_simpleboot3/admin/impression/index.html";i:1654305673;s:67:"/www/wwwroot/eliveadmin/themes/admin_simpleboot3/public/header.html";i:1654305693;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<body>
	<div class="wrap">
		<ul class="nav nav-tabs">
            ...
            <li><a href="<?php echo url('Impression/add'); ?>"><?php echo lang('ADD'); ?></a></li>
		</ul>
		<form method="post" class="js-ajax-form" action="<?php echo url('Impression/listOrder'); ?>">
			...
			<table class="table table-hover table-bordered">
				...
				<tbody>
					...
					<tr>
						...
						<td>
                            <a class="btn btn-xs btn-primary" href='<?php echo url("Impression/edit",array("id"=>$vo["id"])); ?>'><?php echo lang('EDIT'); ?></a>
							<a class="btn btn-xs btn-danger js-ajax-delete" href="<?php echo url('Impression/del',array('id'=>$vo['id'])); ?>"><?php echo lang('DELETE'); ?></a>
						</td>
					</tr>
