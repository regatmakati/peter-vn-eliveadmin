<?php /*a:2:{s:75:"/www/wwwroot/eliveadmin/themes/admin_simpleboot3/admin/slide_item/edit.html";i:1768747112;s:67:"/www/wwwroot/eliveadmin/themes/admin_simpleboot3/public/header.html";i:1768747123;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="col-md-6 col-sm-10">
                                <label class="radio-inline"><input type="radio" name="post[hf_isshow]" value="0" <?php echo !empty($result['hf_isshow']) ? '' : 'checked'; ?>>否</label>
                                <label class="radio-inline"><input type="radio" name="post[hf_isshow]" value="1" <?php echo !empty($result['hf_isshow']) ? 'checked' : ''; ?> >是</label>
                            </div>
                        </td>
                    </tr>
                </table>
                    ...
                    <tr>
                        <td>
                            <div style="text-align: center;">
                                ...
                                <a href="javascript:uploadOneImage('图片上传','#thumb','','slide');">
