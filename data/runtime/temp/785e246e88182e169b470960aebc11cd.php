<?php /*a:2:{s:74:"/www/wwwroot/eliveadmin/themes/admin_simpleboot3/admin/contract/index.html";i:1768747080;s:67:"/www/wwwroot/eliveadmin/themes/admin_simpleboot3/public/header.html";i:1768747123;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<!--			<li><a href="<?php echo url('contract/add'); ?>"><?php echo lang('ADD'); ?></a></li>-->

		</ul>
		<form class="well form-inline margin-top-20" method="post" action="<?php echo url('contract/index'); ?>">
            类型：
			...
			<table class="table table-hover table-bordered">
				...
				<tbody>
					...
					<tr>
						...
						<td><?php echo $vo['contract']; ?></td>
						<td><?php echo $vo['statusMap']; ?></td>
						<td><?php echo $vo['created_at']; ?></td>


						<td>	
                            <a class="btn btn-xs btn-primary" href='<?php echo url("contract/edit",array("uid"=>$vo["uid"],"created_at"=>$vo["created_at"])); ?>'><?php echo lang('EDIT'); ?></a>
							<a class="btn btn-xs btn-danger js-ajax-delete" href="<?php echo url('contract/del',array('uid'=>$vo['uid'],'created_at'=>$vo['created_at'])); ?>"><?php echo lang('DELETE'); ?></a>
						</td>
					</tr>
					<?php endforeach; endif; else: echo "" ;endif; ?>
				</tbody>
