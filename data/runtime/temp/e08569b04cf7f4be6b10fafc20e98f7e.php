<?php /*a:1:{s:71:"/www/wwwroot/eliveadmin/themes/admin_simpleboot3/admin/index/index.html";i:1768747087;}*/ ?>
<!DOCTYPE html>
                ...
                <li class="light-blue dropdown" style="border-left:none;">
                    <a data-toggle="dropdown" href="#" class="dropdown-toggle">
                        ...
                        <span class="user-info">
								<?php echo lang('WELCOME_USER',array('user_nicename' => empty($admin['user_nicename'] )? $admin['user_login'] : $admin['user_nicename'])); ?>
							</span>
