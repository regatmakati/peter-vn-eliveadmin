<?php /*a:2:{s:76:"/www/wwwroot/eliveadmin/themes/admin_simpleboot3/admin/liverecord/index.html";i:1654305676;s:67:"/www/wwwroot/eliveadmin/themes/admin_simpleboot3/public/header.html";i:1654305693;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
			...
			<table class="table table-hover table-bordered">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<?php if(!(empty($vo['allnums']) || (($vo['allnums'] instanceof \think\Collection || $vo['allnums'] instanceof \think\Paginator ) && $vo['allnums']->isEmpty()))): ?>
									<?php echo $vo['allnums']; else: ?>
								    <?php echo $vo['nums']; ?>
							<?php endif; ?>
						</td>
						<!-- <td align="center">
