...
{
    //幻灯片位置：1、PC首页大背景图，2、PC首页左小轮图，3、PC首页右小轮图，4、PC顶部广告图，5、APP首页轮播
    CONST POSITION_INDEX_BIG = 1;
    CONST POSITION_INDEX_LEFT= 2;
    CONST POSITION_INDEX_RIGHT = 3;
    CONST POSITION_INDEX_TOP = 4;
    CONST POSITION_APP_BANNER = 5;

    public static $positionMap = [
        self::POSITION_INDEX_BIG => 'PC首页大背景图',
        self::POSITION_INDEX_LEFT => 'PC首页左小轮图',
        self::POSITION_INDEX_RIGHT => 'PC首页右小轮图',
        self::POSITION_INDEX_TOP => 'PC顶部广告图',
    ...
    public function index()
    {
        ...
        foreach ($slides as $slide) {
            $slide->position = self::$positionMap[$slide->position] ?? '';
        }
    ...
    public function add()
    {
        $this->assign('positionMap', self::$positionMap);
